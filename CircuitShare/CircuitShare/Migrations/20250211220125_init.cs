    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Chargers",
                columns: new[] { "ChargerId", "Description", "HourlyRate", "Name" },
                values: new object[,]
                {
                    { 1, "This is a moderate charger that charges for a low price.", 4.9900000000000002, "Potato Charger" },
                    { 2, "The medium performance charger with a good price.", 6.0, "Berry Charger" },
                    { 3, "It you want the fastest and the best then here it is.", 14.99, "Apple Charger" },
                    { 4, "It works and chargers really well. Believe you me.", 11.99, "Banana Charger" },
                    { 5, "Brought to you by the same technology as the space man company.", 13.49, "Tesla Charger 83" }
                });
