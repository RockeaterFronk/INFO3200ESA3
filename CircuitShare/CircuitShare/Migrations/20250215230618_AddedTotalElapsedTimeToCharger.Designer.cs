...
namespace CircuitShare.Migrations
{
    ...
    [Migration("20250215230618_AddedTotalElapsedTimeToCharger")]
    partial class AddedTotalElapsedTimeToCharger
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CircuitShare.Entities.Charger", b =>
                {
                    ...
                    b.Property<double>("TotalElapsedTime")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("CircuitShare.Entities.PaymentTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CircuitShare.Entities.User", b =>
                {
                    ...
                    b.Property<int?>("ActiveChargerId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CircuitShare.Entities.User", b =>
                {
                    b.HasOne("CircuitShare.Entities.Charger", "ActiveCharger")
                        .WithMany()
                        .HasForeignKey("ActiveChargerId");
